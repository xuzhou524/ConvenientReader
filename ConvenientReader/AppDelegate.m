...
@implementation AppDelegate{
    ...
    ReaderHomeViewController *readerHomeController;
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    readerHomeController = [[ReaderHomeViewController alloc] init]; // Demo view controller
    navigationController = [[UINavigationController alloc] initWithRootViewController:readerHomeController];
